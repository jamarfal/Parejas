...
import static org.example.parejas.Partida.mGoogleApiClient;
...
public class Menu extends Activity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, OnInvitationReceivedListener {
    ...
    public void btnRegalos_Click(View v) {
        ...
        startActivityForResult(Games.Requests.getSendIntent(Partida.mGoogleApiClient, GameRequest.TYPE_GIFT, "".getBytes(), DEFAULT_LIFETIME, mGiftIcon, "Esto es un regalo"), REQUEST_QUESTS);
    }
